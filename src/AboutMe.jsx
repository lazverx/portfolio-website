...
const REVEAL_CONTENT = [
  {
    upper: ["name: Faiz/Laz/Rushi", "age:17"],
...
const ITEMS = [
  {
    id: "twitch", label: "ABOUT ME", handle: "@yourname", href: "https://twitch.tv/lazfrustrante", icon: "🎮", barIcon: icon1, bars: 1, newBars: [0], counts: ["56"],
  ...
  {
    id: "instagram", label: "FUN FACT ABOUT ME", handle: "@yourhandle", href: "https://instagram.com/lazfrust", icon: "📷", barIcon: icon2, bars: 5, newBars: [1, 2], counts: ["3.4M", "2.5M", "676K", "412K", "198K"],
  ...
  {
    id: "tiktok", label: "WIRED FACT ABOUT ME", handle: "@yourhandle", href: "https://tiktok.com/@0xf0000ull", icon: "🎵", barIcon: icon3, bars: 7, newBars: [0, 3, 5, 6], counts: ["5.1M", "3.7M", "2.2M", "1.4M", "831K", "490K", "217K"],
