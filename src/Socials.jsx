...
const ITEMS = [
  {
    id: "twitch", label: "TWITTER", handle: "@lazverx", href: "https://x.com/lazverx", icon: "🎮", barIcon: icon1, bars: 1, newBars: [0], counts: ["56"],
    links: ["twitch.tv/videos/2041837265"],
    stats: [
      { tag: "FOL", value: "51", color: "#9147ff" },
      { tag: "VWR", value: "042",  color: "#bf94ff" },
    ],
  },
  {
    id: "instagram", label: "INSTAGRAM", handle: "@lazfrust", href: "https://instagram.com/lazfrust", icon: "📷", barIcon: icon2, bars: 5, newBars: [1, 2], counts: ["3.4M", "2.5M", "676K", "412K", "198K"],
    ...
    stats: [
      { tag: "FOL", value: "66", color: "#e1306c" },
      { tag: "PST", value: "128",  color: "#f77737" },
    ],
  },
  {
    id: "tiktok", label: "OSU", handle: "@yourhandle", href: "https://v4rx.me/user/profile.php/?id=106", icon: "🎵", barIcon: icon3, bars: 7, newBars: [0, 3, 5, 6], counts: ["5.1M", "3.7M", "2.2M", "1.4M", "831K", "490K", "217K"],
    ...
    stats: [
      { tag: "RNK", value: "40", color: "#00f2ea" },
      { tag: "PP", value: "22K",  color: "#ff0050" },
    ],
  },
];
